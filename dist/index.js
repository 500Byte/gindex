const authConfig = {
  ...
  "siteIcon": "//raw.githack.com/500Byte/gindex/main/dist/favicon.ico", //site icon
...
const themeConfig = {
  // Warehouse Address
  "url": "//rawcdn.githack.com/500Byte/gindex/main/",
  ...
  // Use DPlayer to play, if not filled in, use Plyr to play by default
  "player_dp": "|m3u8|flv|",
  // Thumbnail group
  "thumbnails": [
    {
  ...
  // Video cover, ${fileName} represents the name of the current video
...
<head>
  ...
  <style>
    @import url(//raw.githack.com/500Byte/gindex/main/dist/style.css);
  </style>
  <script>
  ...
  <script src="//raw.githack.com/500Byte/gindex/main/dist/js/app.js"></script>
...
class googleDrive {
   ...
   * @param child_id
   * @returns { Promise<string> } [Note] If the item represented by this id is not under the target gd disk, this method will return an empty string ""
   */
